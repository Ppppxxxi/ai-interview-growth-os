...
- [ ] README 链接 Roadmap、Release Notes、Portfolio Case Study、Agent 合约和公开风险说明。
...
- [ ] README 明确当前是本地 Demo / Personal MVP，不承诺真实 LLM 能力。
...
- [ ] 如暂时没有截图，也可以先发布 README + Case Study，后续补图。
